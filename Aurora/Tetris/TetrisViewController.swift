...
class TetrisViewController: UIViewController {
  ...
  private let closeButton: UIButton = {
    ...
    button.tintColor = .auroraLightBlueGrey
  ...
  private let pauseButton: HighlightableButton = {
    ...
    button.titleLabel?.font = .aurora24DynamicBold
  ...
  private let nextLabel: UILabel = {
    let label = UILabel()
    label.translatesAutoresizingMaskIntoConstraints = false
    label.font = .aurora24DynamicBold
    label.textColor = .auroraText
    label.numberOfLines = 0
    label.textAlignment = .center
    label.sizeToFit()
  ...
  private let gameOverLabel: UILabel = {
    let label = UILabel()
    label.translatesAutoresizingMaskIntoConstraints = false
    label.font = .aurora50DynamicBold
  ...
  private let tryAgainLabel: PaddingLabel = {
    ...
    label.translatesAutoresizingMaskIntoConstraints = false
    label.font = .aurora28DynamicBold
    label.textColor = UIColor.black
    label.numberOfLines = 0
  ...
  func setupBackground() {
    ...
    background.setDiagonalGradient(startColor: .auroraDarkBlue, endColor: .auroraBlue)
  }
